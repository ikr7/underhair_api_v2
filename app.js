...
var express = require('express'), 
	...
	generators = {
		...
		'xml': require('./lib/generators/xml.js'), 
		'yaml': require('./lib/generators/yaml.js')
	};
...
app.get(/^\/v1\/\d+x\d+\.(png|jpg|jpeg|gif|svg|json|pdf|msgpack|xml|yaml)$/i, function(req, res){
